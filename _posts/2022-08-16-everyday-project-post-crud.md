...
<br/>
# 마무리
게시글의 등록부터 수정, 삭제까지 모두 API 연결하여 개발해보면서 다양한 에러들과 많은 고민들을 겪었습니다.
...
<br/><br/>하지만 동시에 해결해나가기 위해 저만의 방법을 찾아보면서 그 문제들을 해결해냈고 끝에는 잘 마무리하였습니다. 결과적으로 해냈다는 성취감을 느낄 수 있어, 뿌듯한 시간이 된 것 같습니다.
